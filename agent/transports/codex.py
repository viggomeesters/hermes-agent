...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        #
        # xAI's and ChatGPT/Codex's Responses endpoints expose a first-class
        # ``web_search`` built-in. When Hermes already exposes its client-side
        # function, replace that declaration one-for-one: duplicate names are
        # rejected by the provider. Other tools remain client-side, and generic
        # OpenAI-compatible/GitHub Responses endpoints keep Hermes's function.
